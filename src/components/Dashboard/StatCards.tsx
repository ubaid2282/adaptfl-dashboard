...
//     if (timestamp === 0) {
//       return "Never Checked"; // Handle the initial case where the timestamp is 0
//     }
  
//     if (typeof timestamp !== "string") {
//       timestamp = String(timestamp); // Convert number to string if needed
//     }
...
//         }
//         // Ensure lastCheckedTimestamp is handled correctly
//         let lastCheckedTimestamp = result.last_checked_timestamp;
//         if (lastCheckedTimestamp === 0 || lastCheckedTimestamp === "0") {
//           lastCheckedTimestamp = "Never Checked"; // Special case for initial startup
//         } else {
