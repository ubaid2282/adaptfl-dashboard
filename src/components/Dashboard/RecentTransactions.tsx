...
export const RecentTransactions = () => {
  ...
  return (
    <div className="col-span-12 p-4 rounded border border-stone-300 bg-white shadow-md">
      <div className="mb-4 flex items-center justify-between">
  ...
  return (
    <thead>
      <tr className="text-sm font-normal text-stone-500 border-b">
        <th className="text-start p-2">Client ID</th>
        <th className="text-start p-2">Status</th>
        <th className="text-start p-2">Date</th>
        <th className="text-start p-2">Contribution Count</th>
        <th className="w-8"></th>
      </tr>
    </thead>
  );
...
const TableRow = ({
  ...
  return (
    <tr className={order % 2 ? "bg-stone-100 text-sm" : "bg-white text-sm"}>
      <td className="p-2">{cusId}</td>
      ...
      <td className="p-2">{contributionCount}</td>
    </tr>
  );
};